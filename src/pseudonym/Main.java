...
//import pseudonym.hasher.Pbkdf2;
...
//import pseudonym.normalizer.NullNormalizer;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        for (Project project : salts_repo.salts) {
            Pseudonymizer pseudonymizer = new Pseudonymizer(project.encrypted_salt, storage_key, new DefaultCprNormalizer(), new Scrypt());
